...
$father=test_input($_POST['father']);
	if ( (!$gender) || (!$name)|| (!$email) || (!$day)|| (!$month)|| (!$year)||	(!$state) || (!$city)||(!$father)|| (!$address)  || (!$mobile) || (!$account)|| (!$income)||(!$password))
	...
	if(!$account){
		$errorMsg .= "*Account no<br>";
	}
	if(!$father){
		$errorMsg .= "*Father name<br>";
	}
	if(!$income){
		$errorMsg .= "*income<br>";
	}
...
$flag =mysqli_query($conn,"INSERT INTO  agents(name,email,state,city,address,gender,mobile,account,income,dob,password,father_name) VALUES('$name','$email','$state','$city','$address','$gender','$mobile','$account','$income','$dob','$password','$father')");
...
?> 
 <div class="container">
   ...
   <div class="services">
	  ...
	  <?php echo $errorMsg; ?>
	     <form method="post" action="apply_agent.php">
		   ...
		   <div class="form-group">
		      <label for="edit-name">Father Name <span class="form-required" title="This field is required.">*</span></label>
		      <input type="text" id="edit-name" name="father" value="" size="60" maxlength="60" class="form-text required">
		    </div>
		    ...
		    <div class="form-group">
		      ...
		      <input type="text" id="edit-name" name="password" value="" size="60" maxlength="60" class="form-text required">
		    </div>
			 <div class="form-group">
            ...
            <div class="col-sm-4 form_box2">
			   ...
			   <div class="form-group">
		      <label for="edit-name">Bank Account Number <span class="form-required" title="This field is required.">*</span></label>
		      <input type="text" id="edit-name" name="account" value="" size="60" maxlength="60" class="form-text required">
		    </div>
			 <div class="form-group">
