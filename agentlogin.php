...
if ($_POST) {
	...
	if ((!$email) || (!$pass)) { 
		...
		//$pass = md5($pass);
      $res = mysqli_query($conn,"SELECT * FROM agents WHERE 	email='$email'and password='$pass' and status='agent'"); 
...
while ($row = mysqli_fetch_assoc($res)) {
					...
					$_SESSION['agentemail'] = $user_email;
$licence_no = $row["licence_no"];
					$_SESSION['agentemail'] = $licence_no;
...
<body>
      <?php include'include/agentnav.php'; ?>
<!-- ============================  Navigation End ============================ -->
 <?php include'agent_login_body.php'; ?>
